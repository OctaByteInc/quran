...
stub = edition_rpc.EditionSvcStub(channel)


def test_create_edition():
    edition = entity_proto.Edition(id='edition-1', language='en', name='edition-name-1',
    ...
    # Second insert
    edition = entity_proto.Edition(id='edition-2', language='en', name='edition-name-1',
    ...
    edition = entity_proto.Edition(id='edition-3', language='en', name='edition-name-3',
