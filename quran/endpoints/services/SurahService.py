...
class SurahService(surah_rpc.SurahSvcServicer):
    ...
    def CreateSurah(self, request, context):
        ...
        return entity_proto.Surah(**res.to_dict())
    ...
    def GetAll(self, request, context):
        ...
        for surah in surah_stream:
            surah_list.append(entity_proto.Surah(**surah.to_dict()))
    ...
    def FindSurahById(self, request, context):
        ...
        return entity_proto.Surah(**surah.to_dict())
